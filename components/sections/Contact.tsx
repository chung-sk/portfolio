      ...
      <div className="max-w-2xl mx-auto text-center">
        ...
        <FadeIn delay={0.4}>
          <a
            ...
            className="inline-block group relative px-8 py-4 font-mono text-lg terminal-border bg-background hover:bg-primary/10 transition-all duration-300 overflow-hidden"
          >
